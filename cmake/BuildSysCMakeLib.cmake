...
MACRO(INITIALIZE_BUILD)
  ...
  ELSE(NOT BUILDSYS_BUILD_PLATFORM)
    ...
    SET(PREFIX_DIR ${PROJECT_DIR}/../library/usr_${BUILDSYS_BUILD_PLATFORM})
    SET(BUILDSYS_LIBRARY_PATH ${PROJECT_DIR}/../library/usr_${BUILDSYS_BUILD_PLATFORM})  
  ...
  #LIST(APPEND CMAKE_PREFIX_PATH ${PROJECT_DIR}/../library/usr_${BUILDSYS_BUILD_PLATFORM})
